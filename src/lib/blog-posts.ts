...
export function getPostsByCountry(countryCode: string, locale?: string): BlogPost[] {
  ...
  {
    id: 126,
    title: "Japan Public Holidays: Mountain Day & Sea Day Explained",
    slug: "japan-public-holidays-mountain-sea-day",
    category: "guide",
    author: "PubHoliday 研究团队",
    publishedDate: "2026-08-20T08:00:00Z",
    lastModified: "2026-08-20T08:00:00Z",
    imageUrl: "https://public-holidays.shop/images/blog/japan-mountain-sea-day.svg",
    excerpt: "Japan's Mountain Day and Sea Day are modern holidays created to reconnect people with nature. Here's when they fall in 2026, how to extend them, and why they matter.",
    relatedCountries: ["JP"],
    locale: "en",
    faq: [
      { question: "When is Mountain Day in 2026?", answer: "August 11, 2026 (Tuesday). Take Monday August 10 off for a four-day mountain weekend." },
      { question: "When is Sea Day in 2026?", answer: "July 21, 2026 (Monday). It already creates a three-day weekend with no bridge day needed." },
      { question: "Why does Japan have Mountain Day and Sea Day?", answer: "Both were created in 2016 to encourage appreciation of nature. Mountain Day honors Japan's forests and mountains; Sea Day honors the ocean's resources and bounty." },
    ],
    content: `
      <p>Japan's holiday calendar includes two relatively young additions: <strong>Mountain Day (山の日)</strong> and <strong>Sea Day (海の日)</strong>. Both were established in 2016 to reconnect people with the natural resources Japan depends on. In 2026, they fall on dates that make long weekends easy to assemble — especially Mountain Day, which lands on a Tuesday.</p>

      <h2>Mountain Day: August 11, 2026</h2>
      <p>Mountain Day was created to honor Japan's forests and mountains, which cover roughly 73% of the country. The holiday falls on <strong>August 11</strong> every year. In 2026 it lands on a Tuesday, which means one paid day off gives you a four-day weekend from August 8 to August 11.</p>
      <p>This is one of the best bridge-day opportunities in the summer calendar. The Japanese Alps, national parks, and mountain temples are all accessible, and the weather in mid-August is warm but not yet humid enough to be uncomfortable at altitude.</p>

      <h2>Sea Day: July 21, 2026</h2>
      <p>Sea Day celebrates the ocean's bounty and Japan's relationship with the sea. In 2026 it falls on <strong>July 21</strong>, a Monday — which means it already creates a three-day weekend with no bridge day required. The date was moved from the third Monday of July to July 21 for the 2020 Tokyo Olympics, and it stayed there afterward.</p>
      <p>Coastal destinations like Okinawa, Shikoku, and the Seto Inland Sea are ideal for a summer getaway. Ferry schedules and beach crowds peak in late July, so book early.</p>

      <h2>Why these holidays matter</h2>
      <p>Before 2016, Japan's calendar was dominated by historical and political dates. Mountain Day and Sea Day were the first holidays explicitly designed around nature and well-being. They reflect a broader shift: Japan recognized that its population needed more connection to the natural world, not less.</p>

      <h2>How to extend Mountain Day in 2026</h2>
      <ul>
        <li>Take Monday August 10 off → four-day weekend (Aug 8-11)</li>
        <li>Combine with Obon travel: fly into Takamatsu or Hiroshima, then into the Chūgoku mountains</li>
        <li>Stay in a ryokan near a national park for the full experience</li>
      </ul>

      <h2>FAQ</h2>
      <p><strong>Is Mountain Day a national holiday?</strong> Yes. It is one of Japan's 16 nationwide public holidays.</p>
      <p><strong>Can I use both Mountain Day and Sea Day in the same summer?</strong> Yes. Sea Day is July 21 and Mountain Day is August 11 — both in summer, both excellent for long weekends.</p>
      <p><strong>Are these holidays unique to Japan?</strong> Yes. Other countries have nature-themed holidays, but the specific form of Mountain Day and Sea Day as annual paid days off is distinctly Japanese.</p>
      <p>See the full <a href="https://public-holidays.shop/en/JP/2026">Japan 2026 holiday calendar</a> for all 16 national holidays and their long weekend potential.</p>
    `,
  },
  {
    id: 127,
    title: "日本公共假日：山之日与海的日的由来与拼假技巧",
    slug: "japan-public-holidays-mountain-sea-day",
    category: "guide",
    author: "PubHoliday 研究团队",
    publishedDate: "2026-08-20T08:00:00Z",
    lastModified: "2026-08-20T08:00:00Z",
    imageUrl: "https://public-holidays.shop/images/blog/japan-mountain-sea-day.svg",
    excerpt: "日本的中山之日和海的日是最年轻的两个法定假日，2026 年各落在不同星期，拼假技巧完全不同。本文讲清来源、日期和每个假日的最优拼法。",
    relatedCountries: ["JP"],
    locale: "zh",
    faq: [
      { question: "2026 年山之日是哪天？", answer: "8 月 11 日周二。请掉 8 月 10 日周一，即可连休四天（8 月 8 日-11 日）。" },
      { question: "2026 年海的日是哪天？", answer: "7 月 21 日周一。已经是三连休，无需拼假。" },
      { question: "为什么日本会有山之日和海的日？", answer: "两者都是 2016 年新增的假日，目的是让国民重新亲近自然。山之日致敬森林与山脉，海的日致敬海洋资源。" },
    ],
    content: `
      <p>日本的假日历法中，<strong>山之日（山之日）</strong>和<strong>海的日（海的日）</strong>是两个相对年轻的新成员，均在 2016 年设立，目的是让国民重新亲近自然。2026 年，它们的日期恰好落在不同的星期，拼假难度截然不同。</p>

      <h2>山之日：2026 年 8 月 11 日（周二）</h2>
      <p>山之日致敬日本的森林与山脉——日本约 73% 的国土是山地。2026 年它落在周二，请掉前一天周一，就能获得四天连休（8 月 8 日-11 日）。这是夏季最容易实现的长周末之一。</p>
      <p>日本阿尔卑斯、国立公园和山间寺庙都适合这个假期。八月中旬高海拔地区凉爽干燥，是登山和避暑的好时机。</p>

      <h2>海的日：2026 年 7 月 21 日（周一）</h2>
      <p>海的日致敬海洋的资源与恩惠。2026 年它落在周一，已经是三连休，无需任何拼假。冲绳、四国、濑户内海都是理想的夏日海滨目的地。七月底是旺季，建议提前预订渡轮和民宿。</p>

      <h2>为什么这两个假日重要</h2>
      <p>在 2016 年之前，日本的假日历法以历史和政治事件为主。山之日和海的日是有史以来第一批明确以自然和福祉为主题的假日，反映了日本社会的一个转变：人们需要更多与自然联系，而不是更少。</p>

      <h2>2026 年山之日拼假技巧</h2>
      <ul>
        <li>请 8 月 10 日周一 → 四天连休（8 月 8 日-11 日）</li>
        <li>结合盂兰盆节出行：飞抵高松或广岛，再进入中国山区</li>
        <li>在国立公园附近的温泉旅馆住宿，体验完整山间假期</li>
      </ul>

      <h2>常见问题</h2>
      <p><strong>山之日是全国假日吗？</strong> 是的，它是日本 16 个全国法定假日之一。</p>
      <p><strong>我可以在同一年用山之日和海的日吗？</strong> 当然。海的日在 7 月 21 日，山之日在 8 月 11 日——都在夏季，都适合长周末。</p>
      <p><strong>这两个假日是日本独有的吗？</strong> 是的。其他国家有自然主题假日，但作为年度带薪假日的形式是日本特有的。</p>
      <p>查看完整的<a href="https://public-holidays.shop/zh/JP/2026">日本 2026 假日日历</a>，了解全部 16 个全国假日及其长周末潜力。</p>
    `,
  },
