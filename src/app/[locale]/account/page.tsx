...
export default function AccountPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <h1 className="text-3xl font-bold">{tNav("account")}</h1>

      {!user ? (
        <div className="mt-8 rounded-xl border border-[var(--border)] p-6">
          <p className="text-[var(--muted)]">{tAccount("signInPrompt")}</p>
          <button
            type="button"
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="rounded-xl border border-[var(--border)] p-6">
            ...
            <p className="mt-2 text-sm text-[var(--muted)]">{tPricing("freePrice")}</p>
            <Link
              href="/pricing"
